...
class Config(object):
    ...
    def __init__(self):
        ...
        x_datadog_tags_max_length = int(os.getenv("DD_TRACE_X_DATADOG_TAGS_MAX_LENGTH", default=128))
        if x_datadog_tags_max_length < 0:
            raise ValueError(
                (
                    "Negative value {!r} provided for DD_TRACE_X_DATADOG_TAGS_MAX_LENGTH, "
